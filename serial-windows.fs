...
: "portname   (  - a u)   
	com? 5 min 1 max 1- cells 'portnames + @ count ;
...
require /usr/local/share/gforth/0.7.3/fflib.fs
library cygwin /cygdrive/c/cygwin/bin/cygwin1.dll
...
: open-comm   (  - )
	...
	makeraw
	serial-fd termios 13 cfsetispeed throw  \ 9600 baud.
	serial-fd termios 13 cfsetospeed throw  \ 9600 baud.
